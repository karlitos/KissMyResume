 ...
 */
const exportToMultipleFormats = async (sourcePath, name, outputPath, theme, paperSize, outputFormats = []) => {
	try {
		...
		// pdf/png export
		exportToPdfAndPng(markup, name,  outputPath, formatsToExport.pdf, formatsToExport.png, paperSize);
 ...
 * @param sourcePath {string} Source path to the resume to be parsed
 * @param theme {Object} The theme object with exposed render metho
 * @returns {Promise<String>} Promise resolving to HTML markup as a string
 */
